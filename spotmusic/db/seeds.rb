...
dumb_luck = gubernator.songs.create(title: "Dumb Luck", played_count: Random.rand(10000))
dumb_luck.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/dumb_luck.mp3"), filename: "dumb_luck.mp3")
helmsman = gubernator.songs.create(title: "Helmsman", played_count: Random.rand(10000))
helmsman.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/helmsman.mp3"), filename: "helmsman.mp3")
crimea = gubernator.songs.create(title: "Crimea", played_count: Random.rand(10000))
crimea.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/crimea.mp3"), filename: "crimea.mp3")
traitors_gate = gubernator.songs.create(title: "Traitors Gate", played_count: Random.rand(10000))
...
big_drop = the_great_bear.songs.create(title: "Big Drop", played_count: Random.rand(10000))
big_drop.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/big_drop.mp3"), filename: "big_drop.mp3")
four_am = the_great_bear.songs.create(title: "4am", played_count: Random.rand(10000))
four_am.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/4_am.mp3"), filename: "4_am.mp3")
waiting = the_great_bear.songs.create(title: "Waiting", played_count: Random.rand(10000))
...
via_laietana = barcelona.songs.create(title: "Via Laietana", played_count: Random.rand(10000))
via_laietana.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/via_laietana.mp3"), filename: "via_laietana.mp3")
passeig_de_gracia = barcelona.songs.create(title: "Passeig de Gràcia", played_count: Random.rand(10000))
...
itaca = barcelona.songs.create(title: "Itaca", played_count: Random.rand(10000))
...
wobbly_way = mystery_club.songs.create(title: "Wobbly Way", played_count: Random.rand(10000))
wobbly_way.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/wobbly_way.mp3"), filename: "wobbly_way.mp3")
very_hazel = mystery_club.songs.create(title: "Very Hazel", played_count: Random.rand(10000))
very_hazel.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/very_hazel.mp3"), filename: "very_hazel.mp3")
favorite_secrets = mystery_club.songs.create(title: "Favorite Secrets", played_count: Random.rand(10000))
...
how_can_i_love_her = covers_besides.songs.create(title: "How can I love her", played_count: Random.rand(10000))
...
save_my_soul = be_love_not_fear.songs.create(title: "Save my Soul", played_count: Random.rand(10000))
save_my_soul.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/save_my_soul.mp3"), filename: "save_my_soul.mp3")
who_am_i = be_love_not_fear.songs.create(title: "Who am I?", played_count: Random.rand(10000))
who_am_i.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/who_am_i.mp3"), filename: "who_am_i.mp3")
jane_the_ripper = be_love_not_fear.songs.create(title: "Jane the Ripper", played_count: Random.rand(10000))
...
freed_from_greed = trinity.songs.create(title: "Freed from Greed", played_count: Random.rand(10000))
freed_from_greed.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/freed_from_greed.mp3"), filename: "freed_from_greed.mp3")
aisling = trinity.songs.create(title: "Aisling", played_count: Random.rand(10000))
...
junkie = paw_paw_tree.songs.create(title: "Junkie", played_count: Random.rand(10000))
junkie.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/junkie.mp3"), filename: "junkie.mp3")
fighting_a_mountain = paw_paw_tree.songs.create(title: "Fighting a Mountain", played_count: Random.rand(10000))
...
wanderin_eyes = paw_paw_tree.songs.create(title: "Wanderin' Eyes", played_count: Random.rand(10000))
wanderin_eyes.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/wanderin_eyes.mp3"), filename: "wanderin_eyes.mp3")
human_hands = paw_paw_tree.songs.create(title: "Human Hands", played_count: Random.rand(10000))
human_hands.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/human_hands.mp3"), filename: "human_hands.mp3")
coffee_chocolate_earth = paw_paw_tree.songs.create(title: "Coffee, Chocolate, Earth", played_count: Random.rand(10000))
...
life = mans_life.songs.create(title: "Life")
...
antares, = aldebaran.songs.create(title: "Antares", played_count: 267017)
...
rai = User.create(name: "Rai Gondim", email: "rai@spotmusic.com", password: "123456", password_confirmation: "123456")
